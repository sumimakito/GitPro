(function() {
  chrome.storage.sync.get(
    ...
    function(items) {
      ...
      const developerProgramMember = jQuery("#js-pjax-container > div > div.h-card.col-3.float-left.pr-3 > div.border-top.border-gray-light.py-3 > div")
      const proContainer = (developerProgramMember.length) ? developerProgramMember
			 : jQuery("#js-pjax-container > div > div.h-card.col-3.float-left.pr-3 > div.border-top.border-gray-light.py-3");
